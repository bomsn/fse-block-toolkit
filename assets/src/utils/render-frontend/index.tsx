...
import { BlockErrorBoundary } from '../../utils';
...
// the event `fse-block-toolkit_render_blocks_frontend` to render its inner blocks.
...
>({
	...
	render(
		<BlockErrorBoundary {...errorBoundaryProps}>
			<Suspense fallback={<div className="fse-block-toolkit-placeholder" />}>
 ...
 * `fse-block-toolkit_render_blocks_frontend` event is triggered.
 */
...
>(
	...
	Array.prototype.forEach.call(wrappersToSkipOnLoad, (wrapper) => {
		wrapper.addEventListener('fse-block-toolkit_render_blocks_frontend', () => {
